...
(function() {
  var Task, TaskQueue, async, fetchTask, http, oi, path, saveTask, url, _,
  ...
  fetchTask = function(taskResourceUrl, taskType, secToken, callback) {
    var fetch_request, headers, options, taskUrl;
    taskUrl = url.parse(taskResourceUrl);
        ...
        if (callback) {
          if (fetch_response.statusCode === 200) {
            ...
            if (_.isEmpty(taskObj)) {
              return callback("No work to process.");
            } else {
  ...
  TaskQueue = (function() {
    ...
    TaskQueue.prototype.process = function(taskType, options, fn) {
      ...
      doFetch = (function(_this) {
        return function() {
          var backoff, getWork, intermediate, maxDelay;
          maxDelay = 30;
          getWork = function(cb) {
      ...
      asyncQ = async.queue((function(_this) {
